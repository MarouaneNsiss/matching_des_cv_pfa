    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/inscription/benificiaire/register/**","/inscription/recruteur/register/**" ,"/swagger-ui/**", "/v3/**", "/inscription/**", "/login","/motDePasseOublié").permitAll() // Routes publiques
