...
public class AuthController {
    ...
    @PostMapping(path = "inscription/benificiaire/register")
    ...
    @PostMapping(path = "inscription/recruteur/register")
    public Recruteur registerRecruteur(@RequestBody RecruteurRegistrationRequestDto requestDTO){
